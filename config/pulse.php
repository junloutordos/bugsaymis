...
return [
    ...
    */
    ...
    'recorders' => [
        ...
        // Servers recorder intentionally omitted: it shells out (shell_exec) for
        // CPU/memory stats, which prod's php.ini disable_functions blocks — it
        // would silently report fake 0% forever rather than fail loudly. ECS
        // Container Insights / CloudWatch (Phase 3) is the real source for
        // infrastructure-level CPU/memory/disk on Fargate.
