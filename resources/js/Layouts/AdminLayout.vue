...
const menuItems = [
...

  {
    ...
    children: [
      ...
      {
        label: "Reservations",
        routeName: "science-lab.reservations.index",
        href: route("science-lab.reservations.index"),
        icon: ClipboardDocumentListIcon,
        permissions: ["lab.request", "lab.manage"],
      },
      {
        label: "Equipment Accountability",
        routeName: "science-lab.equipment-requests.index",
        href: route("science-lab.equipment-requests.index"),
        icon: ClipboardDocumentListIcon,
        permissions: ["lab.request", "lab.manage"],
      },
      {
        label: "Reagent Requests",
        routeName: "science-lab.reagent-requests.index",
        href: route("science-lab.reagent-requests.index"),
        icon: ClipboardDocumentListIcon,
        permissions: ["lab.request", "lab.manage"],
      },
      {
      ...
      },
      {
        ...
        routeName: "science-lab.reports.inventory",
        href: route("science-lab.reports.inventory"),
        icon: ChartBarIcon,
        permissions: ["lab.reports"],
      },
    ],
  },
