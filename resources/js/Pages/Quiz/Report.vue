      ...
      <AppCard>
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wide">Avg accuracy</p>
          </div>
        </div>
      </AppCard>
      <AppCard>
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs font-semibold text-slate-500 uppercase tracking-wide">Avg response</p>
          </div>
        </div>
      </AppCard>
      <AppCard>
