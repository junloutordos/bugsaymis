  ...
  <AdminLayout title="For Approval — Messengerial">
    <div>
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <h1 class="text-xl font-semibold text-slate-800">For Approval — Messengerial Requests</h1>
      </div>
          ...
          <table class="min-w-full divide-y divide-slate-100 text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
              ...
              <tr v-if="filteredRequests.length === 0">
                <td colspan="7" class="py-16 text-center text-slate-400 text-sm">No requests pending your approval.</td>
              </tr>
            </tbody>
          </table>
        </div>
