      ...
      <AppTable :is-empty="!filtered.length" :skeleton-cols="8">
        <template #head>
          <tr>
            ...
            <th class="px-4 py-3 text-center text-[11px] font-semibold text-slate-400 uppercase tracking-wider whitespace-nowrap">Submitted to HR</th>
        ...
        <tr v-for="ipcr in filtered" :key="ipcr.id" class="hover:bg-indigo-50/40">
          <td class="px-4 py-3">
