...
<template>
  ...
  <AdminLayout title="FAD Approval - Facility Requests">
    <div class="space-y-5">
      ...
      <AppPageHeader title="FAD Approval — Facility Requests" subtitle="Facility requests approved by Division Chief, awaiting FAD review" />
      ...
      <AppTable :is-empty="filteredRequests.length === 0" :skeleton-cols="7">
        ...
        <template #empty>
          <EmptyState title="No facility requests pending FAD approval." />
        </template>
