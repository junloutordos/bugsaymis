      ...
      <AppTable :loading="isLoading" :is-empty="!placements.data?.length" :skeleton-cols="7">
        <template #head>
          <tr>
            ...
            <th class="px-4 py-3 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider whitespace-nowrap">Start Date</th>
        ...
        <tr v-for="p in placements.data" :key="p.id" class="hover:bg-indigo-50/40">
