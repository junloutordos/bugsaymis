      ...
      <AppTable :is-empty="!applicants.data?.length" :skeleton-cols="8">
        <template #head>
          <tr>
            ...
            <th class="px-4 py-3 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider whitespace-nowrap">Eligibility</th>
            <th class="px-4 py-3 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider whitespace-nowrap">PRC License</th>
            <th class="px-4 py-3 text-center text-[11px] font-semibold text-slate-400 uppercase tracking-wider whitespace-nowrap">Applications</th>
        ...
        <tr v-for="applicant in applicants.data" :key="applicant.id" class="hover:bg-indigo-50/40">
