  ...
  <AdminLayout title="FAD Approval - Vehicle Requests">
    <div>
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
        <div>
          <h1 class="text-xl font-semibold text-slate-800">FAD Approval — Vehicle Requests</h1>
          <p class="text-sm text-slate-500 mt-0.5">Review and recommend vehicle requests pending FAD approval</p>
        </div>
      </div>
          ...
          <table class="min-w-full divide-y divide-slate-100 text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
              ...
              <tr v-if="filteredRequests.length === 0">
                <td colspan="7" class="py-16 text-center text-slate-400 text-sm">No pending vehicle requests for FAD approval.</td>
              </tr>
            </tbody>
          </table>
        </div>
