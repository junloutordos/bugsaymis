  ...
  <AdminLayout title="OCD Approval - IT Job Requests">
    <div>
      ...
      <div class="flex items-center justify-between mb-4 gap-2">
        <h1 class="text-xl md:text-2xl font-bold text-gray-800 truncate">OCD Approval - IT Job Requests</h1>
      </div>
        ...
        <div class="mb-4 flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            ...
            >
              ...
              <option value="Pending OCD Approval">Pending</option>
              <option value="Approved by OCD">Approved</option>
              <option value="Rejected by OCD">Rejected</option>
            </select>
          </div>
        </div>
