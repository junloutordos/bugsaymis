        ...
        <table class="w-full text-sm">
          ...
          <tbody class="divide-y divide-slate-50">
            <tr v-if="units.length === 0">
              <td colspan="7" class="px-4 py-10 text-center text-sm text-slate-400">No academic units yet.</td>
            </tr>
...
const form  = useForm({ id: null, code: '', name: '', unit_type: 'department', head_user_id: null, sort_order: 0, is_active: true })

function openForm(u = null) {
  if (u) {
    Object.assign(form, { id: u.id, code: u.code, name: u.name, unit_type: u.unit_type, head_user_id: u.head_user_id, sort_order: u.sort_order, is_active: u.is_active })
  } else {
    form.reset(); form.id = null; form.unit_type = 'department'; form.is_active = true
  }
  modal.value = true
}
