        ...
        <div class="relative ml-auto w-full max-w-3xl bg-white shadow-2xl flex flex-col h-full">
          ...
          <div class="flex-1 overflow-y-auto px-6 pb-6">
            <AppTable :loading="loadingStudents" :is-empty="filteredStudents.length === 0" :skeleton-cols="7" :card="false">
              <template #head>
                <tr>
                  <th class="px-4 py-2 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider">#</th>
                  <th class="px-4 py-2 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Name</th>
                  <th class="px-4 py-2 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider">PISAY ID</th>
                  <th class="px-4 py-2 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Type</th>
                  <th class="px-4 py-2 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Status</th>
                  <th class="px-4 py-2 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Clearance</th>
                  <th class="px-4 py-2 text-left text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Actions</th>
                </tr>
              </template>
