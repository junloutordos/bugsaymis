...
<h1>ALP DAILY ATTENDANCE RECORD (INTERNAL)</h1>
...
<div class="footer">Internal daily record, not a controlled QMS form | Generated {{ now()->format('m/d/Y') }} | The official PSHS-00-F-DSA-33 monthly Attendance Form is available from the Attendance tab.</div>
</body></html>
