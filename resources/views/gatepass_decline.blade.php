...
<body>
  <div class="center">
    <div class="card">
      <h2>Decline Gate Pass #{{ $gatepass->id }}</h2>
      <p>Please provide a reason for declining this gate pass. The requester will be notified.</p>
