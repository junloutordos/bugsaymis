...
<body>
  <div class="center">
    <div class="card">
      <h1>Gate Pass Declined</h1>
      <p class="meta">The gate pass has been declined and the reason was recorded.</p>
    ...
    (function(){
      ...
      try {
        if (window.opener && !window.opener.closed) {
          window.opener.postMessage({ type: 'gatepassDeclined', id: id, reason: reason }, '*');
        }
      } catch (e) { }
