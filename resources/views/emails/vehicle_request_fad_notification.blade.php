...
<p class="lead">A vehicle request has been approved by the Division Chief and requires FAD Chief recommendation.</p>
...
@section('actions')
@if(!empty($approveUrl))<a class="btn btn-green" href="{{ $approveUrl }}">Recommend Approval</a>@endif
