...
<head>
  <meta charset="utf-8">
  <title>New Work Request Assigned</title>
  <style>
  ...
  <div class="container">
    <div class="card">
      <div class="card-header">
        <h1>New Work Request Assigned</h1>
      </div>
      <div class="card-body">
        <p class="lead">Hello {{ $request->assignedUser?->name ?? 'Staff' }},</p>
        <p>A work request has been assigned to you. Please review the details and take appropriate action.</p>
