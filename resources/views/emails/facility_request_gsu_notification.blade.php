...
<head>
  <meta charset="utf-8">
  <title>GSU Action Required</title>
  <style>
  ...
  <div class="container">
    <div class="card">
      <div class="card-header">
        <h1>Facility Request — GSU Head Action Needed</h1>
      </div>
      <div class="card-body">
        <p class="lead">Hello,</p>
        <p>A facility request has been approved by the division chief and requires GSU Head action.</p>
        ...
        <table class="details" role="presentation">
          ...
          <tr>
            ...
            <td class="value">{{ $request->requestor ?? ($request->email ?? '—') }}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="value">{{ $request->participants ?? '—' }}</td>
          </tr>
        </table>
