...
<head>
    <meta charset="utf-8">
    <title>OCD Approval Needed — IT Job Request</title>
    <style>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h1>OCD Approval — IT Job Request</h1>
            </div>
            <div class="card-body">
                <p class="lead">Hello {{ $ocdApprover->name ?? 'OCD Approver' }},</p>
                <p>IT Job Request <strong>{{ $jobRequest->itjr_no }}</strong> has been approved by the Division Chief and now requires your review and approval.</p>
                ...
                <table class="details" role="presentation">
                    ...
                    <tr>
                        <td class="label">Division Chief Approval Date</td>
                        <td class="value">{{ $jobRequest->dc_approval_date?->format('F j, Y') ?? '—' }}</td>
                    </tr>
                </table>
