...
<head>
    <meta charset="utf-8">
    <title>IT Job Request Status Update</title>
    <style>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h1>IT Job Request — Status Update</h1>
            </div>
            <div class="card-body">
                <p class="lead">Hello {{ $jobRequest->user->name ?? 'User' }},</p>
                <p>Your IT Job Request has been updated. Please see the details below:</p>
                ...
                <p class="muted">You will receive another notification if there are further updates.</p>
            </div>
            <div class="footer">Thanks — {{ config('app.name') }}</div>
        </div>
    </div>
</body>
</html>
