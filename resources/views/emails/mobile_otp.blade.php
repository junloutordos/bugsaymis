...
<p class="lead">Thank you for registering with AtlasGo. Use the verification code below to activate your account.</p>
...
<p style="font-size:13px;color:#64748b;margin-top:16px;">If you did not register for AtlasGo, please ignore this email.</p>
@endsection
