...
<head>
  <meta charset="utf-8">
  <title>Facility Request Approval</title>
  <style>
  ...
  <div class="container">
    <div class="card">
      <div class="card-header">
        <h1>Facility Request — Approval Needed</h1>
      </div>
      <div class="card-body">
        <p class="lead">Hello {{ $request->unit ?? 'Division Chief' }},</p>
        <p>A new facility request has been submitted and assigned to you for review and approval.</p>
        ...
        <table class="details" role="presentation">
          ...
          <tr>
            ...
            <td class="value">
              ...
              @else
                {{ $request->equipment ?? ($request->others ?? '—') }}
              @endif
            </td>
          </tr>
        </table>
