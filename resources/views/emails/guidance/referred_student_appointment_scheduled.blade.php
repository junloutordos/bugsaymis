...
<head>
  <meta charset="utf-8">
  <title>Guidance Consultation Appointment</title>
  <style>
  ...
  <div class="container">
    <div class="card">
      <div class="card-header">
        <h1>Guidance Consultation Appointment</h1>
      </div>
      <div class="card-body">
        <p class="lead">Hello {{ $studentName ?? 'Student' }},</p>
        <p>The Guidance Office would like to meet with you for a consultation. You are welcome, and this is part of supporting your well-being and growth.</p>
        ...
        <p>If you have questions, you may reach out to the Guidance Office.</p>
      </div>
