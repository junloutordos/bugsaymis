...
<head>
  <meta charset="utf-8">
  <title>Student Referred to Guidance</title>
  <style>
  ...
  <div class="container">
    <div class="card">
      <div class="card-header">
        <h1>Your Student is Referred to the Guidance Office</h1>
      </div>
      <div class="card-body">
        <p class="lead">Hello {{ $teacherName ?? 'Teacher' }},</p>
        <p>One of your students has been referred to the Guidance Office. Please see the scheduled consultation details below.</p>
        ...
        <table class="details" role="presentation">
          ...
          <tr>
            <td class="label">Consultation Date & Time</td>
            <td class="value">{{ optional($consult->date_time_assigned)->toDayDateTimeString() ?? $consult->date_time_assigned ?? '—' }}</td>
          </tr>
        </table>

        <p>Please support your student by coordinating with the Guidance Office when needed.</p>
      </div>
