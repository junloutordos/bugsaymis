    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h1>Follow-up Consultation Scheduled</h1>
            </div>
            <div class="card-body">
                <p class="lead">Hello {{ $studentName ?? 'Student' }},</p>
                <p>This is to inform you that a follow-up guidance consultation has been scheduled. Please see the details below.</p>
                ...
                <table class="details" role="presentation">
                    ...
                    <tr>
                        ...
                        <td class="value">{{ isset($followupDate) ? \Illuminate\Support\Carbon::parse($followupDate)->toDayDateTimeString() : ($consult->followup_date ? optional($consult->followup_date)->toDayDateTimeString() : '—') }}</td>
                    </tr>
                </table>
