...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h1>IPCR Signed by the Director ✓</h1>
            <p>Individual Performance Commitment and Review</p>
        </div>
        <div class="card-body">
            <p>Dear {{ $recipientName }},</p>
            <p>The IPCR has been <strong>signed by the Director (OCD)</strong>. The performance review process is now complete.</p>
            <table class="details" role="presentation">
                ...
                <tr><td class="label">Signed At</td><td class="value">{{ $ipcr->director_signed_at ? \Carbon\Carbon::parse($ipcr->director_signed_at)->format('F j, Y, g:i A') : now()->format('F j, Y, g:i A') }}</td></tr>
            </table>
