...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h1>IPCR — Submitted for Your Review</h1>
            <p>Individual Performance Commitment and Review</p>
        </div>
        <div class="card-body">
            <p>Dear {{ $recipientName }},</p>
            <p>An employee has submitted their IPCR targets for your review and approval. Please log in to {{ config('app.name') }} to review.</p>
