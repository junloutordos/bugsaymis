...
<head>
    ...
    <style>
        ...
        .card-header { background:linear-gradient(90deg,#7c3aed,#8b5cf6); padding:20px 24px; color:#fff; }
        ...
        .value { color:#0f172a; }
        .badge { display:inline-block; padding:2px 10px; border-radius:9999px; font-size:12px; font-weight:600; background:#ede9fe; color:#5b21b6; }
...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h1>IPCR Submitted to PMT for Review</h1>
            <p>Individual Performance Commitment and Review</p>
        </div>
        <div class="card-body">
            <p>Dear {{ $recipientName }},</p>
            <p>An IPCR has been submitted to the PMT (Performance Management Team) for review. Please log in to {{ config('app.name') }} to evaluate.</p>
            ...
            <a class="btn" href="{{ route('pmt-ipcr.show', $ipcr->id) }}">Review IPCR</a>
        </div>
