...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h1>IPCR Returned for Revision</h1>
            <p>Individual Performance Commitment and Review</p>
        </div>
        <div class="card-body">
            <p>Dear {{ $recipientName }},</p>
            <p>Your IPCR has been <strong>returned for revision</strong> by your Division Chief following feedback from the PMT. Please log in to {{ config('app.name') }} to review and make the necessary updates.</p>
