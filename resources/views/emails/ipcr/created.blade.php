...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h1>New IPCR Created — Review Needed</h1>
            <p>Individual Performance Commitment and Review</p>
        </div>
        <div class="card-body">
            <p>Dear {{ $recipientName }},</p>
            <p>A new IPCR has been created by an employee under your division. Please log in to {{ config('app.name') }} to review.</p>
            <table class="details" role="presentation">
                ...
                <tr><td class="label">Date Created</td><td class="value">{{ now()->format('F j, Y, g:i A') }}</td></tr>
            </table>
