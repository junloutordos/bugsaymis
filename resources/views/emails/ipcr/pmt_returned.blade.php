...
<div class="callout callout-red">
    ...
    Review the PMT's feedback in Atlas, inform the employee of the required revisions, then use <strong>Return to Employee</strong> and resubmit after corrections.
</div>
@endsection
