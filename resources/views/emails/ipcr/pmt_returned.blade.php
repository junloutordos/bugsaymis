...
<head>
    ...
    <style>
        ...
        .card-header { background:linear-gradient(90deg,#dc2626,#ef4444); padding:20px 24px; color:#fff; }
        ...
        .value { color:#0f172a; }
        .badge { display:inline-block; padding:2px 10px; border-radius:9999px; font-size:12px; font-weight:600; background:#fee2e2; color:#991b1b; }
        .btn { display:inline-block; background:#dc2626; color:#fff; padding:11px 22px; border-radius:8px; text-decoration:none; font-weight:600; font-size:14px; margin-top:16px; }
...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h1>IPCR Returned by PMT for Revision</h1>
            <p>Individual Performance Commitment and Review</p>
        </div>
        <div class="card-body">
            <p>Dear {{ $recipientName }},</p>
            <p>The PMT (Performance Management Team) has <strong>returned the following IPCR for revision</strong>. Please coordinate with the employee to address the PMT's feedback.</p>
            ...
            <a class="btn" href="{{ route('division-employee-ipcr.show', $ipcr->id) }}">View IPCR</a>
        </div>
