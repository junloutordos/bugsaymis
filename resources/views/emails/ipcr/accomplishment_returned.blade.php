...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h1>IPCR Accomplishment Returned for Revision</h1>
            <p>Individual Performance Commitment and Review</p>
        </div>
        <div class="card-body">
            <p>Dear {{ $recipientName }},</p>
            <p>Your accomplishment submission has been <strong>returned for revision</strong> by your Division Chief. Please log in to {{ config('app.name') }} to update and resubmit.</p>
