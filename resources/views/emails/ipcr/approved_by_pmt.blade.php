...
<div class="container">
    <div class="card">
        <div class="card-header">
            <h1>IPCR Approved by PMT — Director Signature Required</h1>
            <p>Individual Performance Commitment and Review</p>
        </div>
        <div class="card-body">
            <p>Dear {{ $recipientName }},</p>
            <p>An IPCR has been <strong>approved by the PMT</strong> and is now awaiting your signature as Director. Please log in to {{ config('app.name') }} to sign.</p>
            ...
            <a class="btn" href="{{ route('pmt-ipcr.show', $ipcr->id) }}">Sign IPCR</a>
        </div>
