...
Route::middleware(['auth', 'pshs.email'])->group(function () {
    ...
    */
    ...
    // ── CSM Feedback Center (admin/MIS/Evaluation Committee) ──────────────────
    ...
    Route::get('/csm/list',      [\App\Http\Controllers\CSMFeedbackController::class, 'index'])
        ->middleware('permission:csm.view')
        ->name('csm.list');
    Route::get('/csm/list/{csmResponse}', [\App\Http\Controllers\CSMFeedbackController::class, 'show'])
        ->middleware('permission:csm.view')
        ->name('csm.show');
    Route::get('/csm/export',    [\App\Http\Controllers\CSMFeedbackController::class, 'export'])
        ->middleware('permission:csm.view')
        ->name('csm.export');
    ...
    */
    Route::middleware('permission:users.view')->group(function () {
        ...
        Route::post('users/{user}/photo', [UserController::class, 'updatePhoto'])->name('users.photo.update')->middleware('permission:hr.employees.manage');
    ...
    Route::middleware('permission:opcr.view|opcr.manage')->group(function () {
        ...
        Route::middleware('permission:opcr.manage')->group(function () {
            ...
            Route::put('/opcr-indicators/{opcrIndicator}/accomplishment', [\App\Http\Controllers\OPCR\OpcrIndicatorController::class, 'updateAccomplishment'])->name('opcr-indicators.accomplishment');
        });
    });
