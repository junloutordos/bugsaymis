...
class DtrRecord extends Model
{
    ...
    protected $fillable = [
        ...
        'undertime_minutes',
        'overtime_minutes',
        'gatepass_deduction_minutes',
        'gatepass_undertime_minutes',
        'day_type',
        'attendance_status',
    ...
    protected $casts = [
        ...
        'gatepass_deduction_minutes' => 'decimal:2',
        'gatepass_undertime_minutes' => 'decimal:2',
        'is_posted'      => 'boolean',
        'is_locked'      => 'boolean',
        'is_travel'      => 'boolean',
        'is_advance'     => 'boolean',
        'wfh_overridden' => 'boolean',
        'time_manually_edited' => 'boolean',
