...
class PermissionsSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['module' => 'Faculty Loading', 'name' => 'faculty_loading.subjects.view',    'description' => 'View subject catalog'],
            ['module' => 'Faculty Loading', 'name' => 'faculty_loading.subjects.manage',  'description' => 'Manage subject catalog'],
